...
The repository is v2.2.1. The spec's version line is out of date.
...
- [ ] Update KERNEL_SPECIFICATION.md version to v2.2.1
...
6. Update KERNEL_SPECIFICATION.md version to v2.2.1

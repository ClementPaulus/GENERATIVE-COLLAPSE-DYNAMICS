...
The repository is v2.1.5. The spec's version line is out of date.
...
- [ ] Update KERNEL_SPECIFICATION.md version to v2.1.5
...
6. Update KERNEL_SPECIFICATION.md version to v2.1.5

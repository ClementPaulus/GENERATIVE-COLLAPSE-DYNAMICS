...
both achieve \emph{distorted lensing} or \emph{thin arc}
classification.  When light bends around a black hole to form
...
uniformity.  Iron-56 is also the end product of stellar
fusion --- the element at which a star's collapse-return
engine reaches thermodynamic equilibrium.  The energetic
optimum and the coherence optimum coincide across scales.
...
the geometry has compounded: one reasons from structure,
not from domain expertise.  The same geometric intuition
is powerful enough to derive a clinical diagnosis from first
principles (Sec.~\ref{sec:memory}).

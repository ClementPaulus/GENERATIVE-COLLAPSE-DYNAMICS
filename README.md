...
[![Tests: 15,998](https://img.shields.io/badge/tests-15%2C998-brightgreen.svg)](tests/)
...
Tier-1 (44 structural identities, 47 lemmas, 252 proven theorems) → Tier-0 (15,998 tests, 193 closure modules, C++17 accelerator) → Tier-2 (20 domains from particle physics to consciousness). One-way dependency. No back-edges within a frozen run.
...
pytest -v --tb=short                       # 15,998 tests
```
...
2. **Test** — Full pytest suite (15,998 tests, 185 test files)
...
**15,998 tests** across **185 test files**, organized by tier and domain:
...
├── tests/                     # 185 test files, 15,998 tests

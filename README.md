...
[![Tests: 19,448](https://img.shields.io/badge/tests-19%2C448-brightgreen.svg)](tests/)
...
Tier-1 (44 structural identities, 47 lemmas, 716 proven theorems) → Tier-0 (19,448 tests, 222 closure modules, C++17 accelerator) → Tier-2 (21 domains from particle physics to consciousness). One-way dependency. No back-edges within a frozen run.
...
pytest -v --tb=short                       # 19,448 tests
```
...
2. **Test** — Full pytest suite (19,448 tests, 221 test files)
...
**19,448 tests** across **221 test files**, organized by tier and domain:
...
├── tests/                     # 221 test files, 19,448 tests
